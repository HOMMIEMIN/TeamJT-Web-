						...
						<div class="box">
							<div class="content">
								<div class="set-profileimg">
									...
									<a id="select-img" href="javascript:void(0)" onclick=><img src="" alt="사진선택"></a>
								</div>
								<div class="set-username">
									<input class="big-text" id="username" type="text" name="username" value="${userName}" /> <a
										id="edit-username" href="javascript:void(0)" onclick=><img src="" alt="닉네임수정"></a>
									<div>${userId}</div>
								</div>
								<div class="set-phone">
									<div class="content-title">전화번호</div>
									<input class="big-text" id="phone" type="number" name="phone" value="${phone}" /> <a
										id="edit-phone" href="javascript:void(0)" onclick=><img src="" alt="번호수정"></a>
								</div>
								<hr>
								<div class="set-password">
									<div class="content-title">비밀번호 변경</div>
									<input id="curpassword" class="reset-password" type="password" name="curpassword"
										placeholder="기존 비밀번호" />
									<div id="checkedfail" style="display: none; color: red; font-size: 8pt;">비밀번호를 확인해주세요</div>
									<input id="newpassword" class="reset-password" type="password" name="newpassword"
										placeholder="새 비밀번호" /> <input id="checkpassword" class="reset-password" type="password"
										name="checkpassword" placeholder="기존 비밀번호" />
									<div id="checkednotsame" style="display: none; color: red; font-size: 8pt;">새로 입력하신
										비밀번호가 다릅니다</div>
								</div>
							</div>
						</div>
