...
<body>
	...
	<!-- 폴더 이름입력창 -->
	<div id="id02" class="w3-modal" style="position: absolute; height: 200%;">
					...
					<div>
						...
						<form id="createFolder" style="padding-left: 10px; display: inline-block;">
							...
							<div>
								...
								<input type="text" id="folderName1" name="folderName" class="form-control input-lg"
									style="width: 50%; height: 35px; margin-left: 53px; display: inline-block;" />
								 <input	type="text" name="userId" value=${userId } />
							</div>
						</form>
						<br />
						<button id="btnFolder2" class="btn btn-default"
